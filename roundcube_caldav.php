...
class roundcube_caldav extends rcube_plugin
{
    ...
    function preferences_save($save_params): array
    {
        ...
        $save_params['prefs']['server_caldav']['_password'] = $this->oidc_helper->getAccessToken(); // Use OIDC token as password
        ...
        error_log("  Password (Token): " . substr($this->oidc_helper->getAccessToken(), 0, 20) . "...");
    ...
    function try_oidc_connection(): bool
    {
        ...
        $token = $this->oidc_helper->getAccessToken();
